        ...
        <div className='academic-div expand' id='career'>
          ...
          <div className='long-text long-text-box academics' id='career'>
            <div className='long-text-inner'>
              <p className='description'>{`"Before making a transition into software engineering, I started my career as a psychology lecturer, specialising in neuroscience. As a neuroscience lecturer, I enjoyed the challenge of presenting complex concepts in accessible, engaging & humorous ways. Across my research career, I have been drawn to understanding how different technologies can be used to support the diagnosis & intervention of developmental disorders. It was collaborating on the development of these technologies that sparked my interest in the world of software development."`}</p>
              <h2>Education</h2>
              <ul>
        ...
        <div className='academic-div expand' id='snowboarder'>
          ...
          <div className='long-text long-text-box academics' id='public-engagement'>
            <div className='long-text-inner'>
              ...
              <h2>Presentations of note</h2>
              <ul>
                <li>Brownhill, Knight {'&'} Norris | Invited speaker: An ADHD Teacher Toolkit - what are the needs? | Bristol Conversations, UoB | 2020</li>
                <li>Knight | Keynote panellist: SEEL Debate for Educational Psychologists: Is an ADHD diagnosis helpful or harmful? | BPS DECP, UCL | 2019</li>
                <li>Knight {'&'} Fancourt | Poster: Sleepy teens: What a difference a delay makes | World Sleep Society conference | 2019</li>
                <li>Knight | Invited speaker: [ADHD] Approaches to assessment {'&'} Intervention | London ADHD Research Forum | 2019</li>
                <li>Knight | Poor sleep in childhood, {'&'} its effect on learning, attention {'&'} behaviour | BrainCanDo, Queen Anne's | Bell House, Centre for Educational Needs | Award ceremony, Fairley House School for Specific Learning Difficulties | 2017-2020</li>
              </ul>
            </div>
          </div>
        </div>
