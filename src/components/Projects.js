        ...
        <div className='proj-selectors img-left' id='proj4'>
          ...
          <div className='content-outer' onClick={handleClick}>
            <div className='proj-content proj-content-left'>
              ...
              <p className='proj-text'>{`Django | REST-framework | PostgreSQL | SASS | TablePlus | React.js | React-Slick (Carousel) >>>`}</p>
            </div>
        ...
        <div className='proj-selectors img-right' id='proj3'>
          <div className='content-outer' onClick={handleClick}>
            ...
            <div className='proj-content proj-content-right'>
              ...
              <p className='proj-text'>{`<< Node.js | MongoDB | Express | B-crypt | React.js | React-bootstrap | React-Slick | SASS`}</p>
            </div>
          </div>
        ...
        <div className='proj-selectors img-left' id='proj2'>
          <div className='content-outer' onClick={handleClick}>
            <div className='proj-content proj-content-left'>
              ...
              <p className='proj-text'>{`Node.js | Express | JavaScript | React.js | React Hooks | SASS >>`}</p>
            </div>
        ...
        <div className='proj-selectors img-right' id='proj1'>
          <div className='content-outer' onClick={handleClick}>
            ...
            <div className='proj-content proj-content-right'>
              ...
              <p className='proj-text'>{`<< JavaScript | HTML | CSS`}</p>
            </div>
          </div>
