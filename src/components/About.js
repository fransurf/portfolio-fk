            ...
            <div className='about-div' id='se'>
              ...
              <div className='about-top'>
                ...
                <div className=' top-contents about-text'>
                  <p>{`I am a junior full-stack developer, familiar with a range of popular languages & frameworks (see my banner below). I aim to produce readable code that anybody can quickly manoeuvre.`} <br></br><br></br>{`My particular fixation is on producing well-structured content in beautiful & fun, dynamic interfaces.`} <br></br><br></br> {`As a software engineer, I am always learning. If there's a problem to solve, you can call me Poirot.`}</p>
                </div>
              </div>
