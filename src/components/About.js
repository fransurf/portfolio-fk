          ...
          <div className='about-div expand' id='se'>
            <div className='about-top'>
              ...
              <div className=' top-contents about-text'>
                <p>{`My particular fixation in software engineering is on producing well-structured content in beautiful & fun dynamic interfaces. Years of lecturing have taught me, it's not merely the content itself but the way it is interacted with that engages an audience.`} <br></br> {`I take the same approach with my code: I don't believe the shortest code is the best. I aim to produce readable code that people can pick up & quickly manoeuvre around.`} <br></br> {`With coding, I am always learning. If there's a problem to solve, you can call me Poirot`}</p>
              </div>
            </div>
            <div className='about-bottom'>
              <h2 className='about-heading' id='se-text'>SOFTWARE ENGINEER</h2>
              <Link to='/projects' className='about-link'>Take a look?</Link>
            </div>
          </div>
          ...
          <div className='about-div expand' id='neuro'>
            <div className='about-top'>
              ...
              <div className='about-text'>
                <p>{`In my heart, I'm an uber geek. And my heart found neuroscience.`} <br></br> {`Understanding human behaviour in terms of the nuanced network of interactions in the brain (& body) fascinates me. And I loved passing that passion onto my students; seeing their faces light up as they began to grasp complex concepts was a joy.`} <br></br> {`Teaching neuroscience has taught me a lot about the importance of engaging a person's interest & breaking down information in order to maximise attention & learning.`}</p>
              </div>
            </div>
            <div className='about-bottom'>
              <h2 className='about-heading' id='neuro-text'>NEUROSCIENTIST</h2>
              <Link to='/academics' className='about-link'>It's all academic</Link>
            </div>
          </div>
